...
class CustomClipPath extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.cubicTo(size.width*0.03, size.height*0.88, size.width*0.05, size.height*0.8, size.width*0.14, size.height*0.84);
    path.lineTo(size.width * 0.4, size.height*0.95);
    path.cubicTo(size.width*0.4, size.height*0.95, size.width*0.5, size.height, size.width*0.55, size.height*0.95);
